...
import com.w3.module.system.dal.mysql.tenant.TenantMapper;
import com.w3.module.system.enums.permission.RoleCodeEnum;
import com.w3.module.system.enums.permission.RoleTypeEnum;
...
import com.w3.module.system.service.tenant.handler.TenantInfoHandler;
import com.w3.module.system.service.tenant.handler.TenantMenuHandler;
...
import static com.w3.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.w3.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.w3.framework.common.util.object.ObjectUtils.cloneIgnoreId;
...
import static com.w3.framework.test.core.util.RandomUtils.*;
import static com.w3.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static com.w3.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateTenant_success() {
        ...
        TenantUpdateReqVO reqVO = randomPojo(TenantUpdateReqVO.class, o -> {
            ...
            TenantBaseVO tenantBaseVO = o.setStatus(randomCommonStatus());
