package com.knd.module.system.service.tenant;
...
import com.knd.framework.common.util.date.DateUtils;
import com.knd.framework.tenant.config.TenantProperties;
import com.knd.framework.tenant.core.context.TenantContextHolder;
import com.knd.framework.tenant.core.util.TenantUtils;
import com.knd.module.system.controller.admin.permission.vo.role.RoleCreateReqVO;
import com.knd.module.system.controller.admin.tenant.vo.tenant.TenantCreateReqVO;
import com.knd.module.system.controller.admin.tenant.vo.tenant.TenantExportReqVO;
import com.knd.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.knd.module.system.controller.admin.tenant.vo.tenant.TenantUpdateReqVO;
import com.knd.module.system.convert.tenant.TenantConvert;
...
import com.knd.module.system.dal.mysql.tenant.TenantMapper;
import com.knd.module.system.enums.permission.RoleCodeEnum;
import com.knd.module.system.enums.permission.RoleTypeEnum;
...
import com.knd.module.system.service.tenant.handler.TenantInfoHandler;
import com.knd.module.system.service.tenant.handler.TenantMenuHandler;
...
import static com.knd.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 knd.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
