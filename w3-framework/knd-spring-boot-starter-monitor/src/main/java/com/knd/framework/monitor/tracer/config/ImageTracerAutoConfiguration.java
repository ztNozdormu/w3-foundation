...
import com.knd.framework.monitor.tracer.core.aop.BizTraceAspect;
import com.knd.framework.monitor.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "knd.tracer", value = "enable", matchIfMissing = true)
public class ImageTracerAutoConfiguration {
