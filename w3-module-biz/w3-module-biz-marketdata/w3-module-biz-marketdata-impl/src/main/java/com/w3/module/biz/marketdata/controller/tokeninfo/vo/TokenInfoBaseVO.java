...
/**
 * TOKEN基本信息 Base VO，提供给添加、修改、详细的子 VO 使用
...
public class TokenInfoBaseVO {
    ...
    */
    ...
    /**
    * description = "交易所类型	      1 币安交易所	      2 欧易交易所	      3 芝麻开门交易所", requiredMode = Schema.RequiredMode.REQUIRED, example = "1"
    */
    @NotNull(message = "交易所类型	      1 币安交易所	      2 欧易交易所	      3 芝麻开门交易所不能为空")
