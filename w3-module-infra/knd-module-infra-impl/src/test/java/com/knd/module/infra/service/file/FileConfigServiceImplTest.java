package com.knd.module.infra.service.file;
...
import com.knd.framework.file.core.enums.FileStorageEnum;
...
import com.knd.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import com.knd.module.infra.controller.admin.file.vo.config.FileConfigUpdateReqVO;
import com.knd.module.infra.dal.mysql.file.FileConfigMapper;
import com.knd.module.infra.mq.producer.file.FileConfigProducer;
import lombok.Data;
...
import static com.knd.framework.test.core.util.RandomUtils.randomLongId;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileClient() {
        ...
        Long id = randomLongId();
        // mock 获得 Client
        FileClient fileClient = new com.knd.framework.file.core.client.local.LocalFileClient(id, new LocalFileClientConfig());
        when(fileClientFactory.getFileClient(eq(id))).thenReturn(fileClient);
