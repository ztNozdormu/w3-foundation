package com.knd.module.infra.service.codegen.inner;
...
import com.knd.framework.codegen.enums.CodegenFrontTypeEnum;
import com.knd.framework.codegen.enums.CodegenSceneEnum;
import com.knd.framework.common.exception.util.ServiceExceptionUtil;
...
import com.knd.framework.common.util.date.LocalDateTimeUtils;
...
import com.knd.framework.mybatis.core.dataobject.BaseDO;
...
import com.knd.framework.operatelog.core.enums.OperateTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "knd-module-${table.moduleName}/" + // 顶级模块
                "knd-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "knd-module-${table.moduleName}/" + // 顶级模块
                "knd-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "knd-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "knd-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
