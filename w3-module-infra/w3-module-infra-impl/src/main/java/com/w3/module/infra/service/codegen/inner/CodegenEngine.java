package com.w3.module.infra.service.codegen.inner;
...
import com.w3.framework.codegen.enums.CodegenFrontTypeEnum;
import com.w3.framework.codegen.enums.CodegenSceneEnum;
import com.w3.framework.common.exception.util.ServiceExceptionUtil;
...
import com.w3.framework.common.util.date.LocalDateTimeUtils;
...
import com.w3.framework.operatelog.core.enums.OperateTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "w3-module-${table.moduleName}/" + // 顶级模块
                "w3-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "w3-module-${table.moduleName}/" + // 顶级模块
                "w3-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "w3-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "w3-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
