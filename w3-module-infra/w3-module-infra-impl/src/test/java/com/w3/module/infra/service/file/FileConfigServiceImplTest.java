package com.w3.module.infra.service.file;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.w3.framework.common.pojo.PageResult;
import com.w3.framework.file.core.client.FileClient;
import com.w3.framework.file.core.client.FileClientConfig;
...
import com.w3.framework.file.core.enums.FileStorageEnum;
...
import com.w3.module.infra.dal.mysql.file.FileConfigMapper;
import com.w3.module.infra.mq.producer.file.FileConfigProducer;
import lombok.Data;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileClient() {
        ...
        Long id = randomLongId();
        // mock 获得 Client
        FileClient fileClient = new com.w3.framework.file.core.client.local.LocalFileClient(id, new LocalFileClientConfig());
        when(fileClientFactory.getFileClient(eq(id))).thenReturn(fileClient);
